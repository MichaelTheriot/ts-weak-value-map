type WeakValueMapKey = ConstructorParameters<typeof WeakRef>[0];

class WeakValueMap<TKey, TValue extends WeakValueMapKey> implements Map<TKey, TValue> {
...
interface WeakValueMap<TKey, TValue extends WeakValueMapKey> {
